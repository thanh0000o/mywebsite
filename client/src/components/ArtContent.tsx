...
interface ArtContentProps {
  onOpenArtViewer?: (art: Artwork) => void;
}

export function ArtContent({ onOpenArtViewer }: ArtContentProps) {
  return (
    <div 
...
export function ArtViewerContent({ art }: { art: Artwork }) {
  ...
  return (
    <div className="w-full h-full flex flex-col p-1" style={{ backgroundColor: '#c0c0c0' }}>
      <div 
        className="flex-1"
        style={{
          borderTop: '2px solid #808080',
          ...
          <div className="flex flex-col h-full">
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1">
                  <span className="text-[8px]" style={{ fontFamily: 'var(--font-pixel)', color: '#000' }}>VOL</span>
                  <div 
                    className="w-16 h-2"
                    style={{
                      backgroundColor: '#fff',
      ...
      {/* Status Bar */}
      <div 
        className="flex items-center justify-between px-2 py-0.5 mt-1 text-[9px]"
        style={{
          backgroundColor: '#C0C0C0',
          borderTop: '1px solid #808080',
          fontFamily: 'var(--font-pixel)',
